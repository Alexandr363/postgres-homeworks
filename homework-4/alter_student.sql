...
VALUES ('Stud1', 'Stud1', '01-01-1901', 111111111),
       ('Stud2', 'Stud2', '02-02-1902', 222222222),
       ('Stud3', 'Stud3', '03-03-1903', 333333333)

-- 7. Удалить все данные из таблицы со сбросом идентификатор в исходное
-- состояние
